...
# Training:
OMP_NUM_THREADS=1 python main.py --nEpochs 25 --shuffle --dataset dev-grapheme-mapped-one-cn --target target_overlap_0.1 --lattice-type word --encoder TRANSFORMER --attn_type scaled-dot --test_epochs --suffix temp --rootDir ../data --onebest
