...
OMP_NUM_THREADS=1 python main.py --nEpochs 25 --shuffle --dataset dev-grapheme-mapped-one-cn --target target_overlap_0.1 --lattice-type word --encoder TRANSFORMER --attn_type mult --test_epochs --suffix mult_1 --rootDir ../data --onebest --epochNum -2 --testOnly --attention_stats --seq_length_stats
